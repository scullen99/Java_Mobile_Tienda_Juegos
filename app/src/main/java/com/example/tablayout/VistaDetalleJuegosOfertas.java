...
public class VistaDetalleJuegosOfertas extends AppCompatActivity {
    int gameId;
    private Button agregarALaCestaOfertas;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vista_detalle_juegos_ofertas);
        ...
        try {
            ...
            agregarALaCestaOfertas = findViewById(R.id.ButonHacerPedido);

            agregarALaCestaOfertas.setOnClickListener(new View.OnClickListener(){
